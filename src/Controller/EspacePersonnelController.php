...
final class EspacePersonnelController extends AbstractController
{
    ...
    public function index(
        ...
        $stats = [
            ['label' => 'Comptes',           'value' => $compteRepository->count([]),           'icon' => 'bi-people-fill',      'variant' => 'comptes'],
            ['label' => 'Étudiants',         'value' => $etudiantRepository->count([]),         'icon' => 'bi-mortarboard',      'variant' => 'etudiants'],
            ['label' => 'Enseignants',       'value' => $enseignantRepository->count([]),       'icon' => 'bi-person-video3',    'variant' => 'enseignants'],
            ['label' => 'Entreprises',       'value' => $entrepriseRepository->count([]),       'icon' => 'bi-buildings',        'variant' => 'entreprises'],
            ['label' => 'Matières',          'value' => $matiereRepository->count([]),          'icon' => 'bi-bookmark-star',    'variant' => 'matieres'],
            ['label' => 'Offres alternance', 'value' => $offreAlternanceRepository->count([]),  'icon' => 'bi-briefcase',        'variant' => 'alternance'],
            ['label' => 'Projets tuteurés',  'value' => $projetTuteureRepository->count([]),    'icon' => 'bi-kanban',           'variant' => 'projets'],
            ['label' => 'Supports',          'value' => $supportCoursRepository->count([]),     'icon' => 'bi-file-earmark-pdf', 'variant' => 'supports'],
        ];
    ...
    {
        /** @var \App\Entity\Compte|null $user */
        $user = $this->getUser();
